...
线性评估结果如图2所示。SimSiam达到了67.7%的非平凡精度。如5次试验的标准试验所示，该结果相当稳定。仅去除停止梯度，准确度就变为0.1%，这是ImageNet中的概率水平猜测。
