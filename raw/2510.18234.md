...
Token: n×(100||256) + (256||400)
Valid: n×(100||256) + (256||400)×R
n∈[2:9]
...
n×256+400
Process
resize resize padding padding resize + padding resize + padding
...
𝑁𝑣𝑎𝑙𝑖𝑑= ⌈𝑁𝑎𝑐𝑡𝑢𝑎𝑙× [1 −((𝑚𝑎𝑥(𝑤, ℎ) −𝑚𝑖𝑛(𝑤, ℎ))/(𝑚𝑎𝑥(𝑤, ℎ)))]⌉
(1)
...
tigating how many vision tokens are required to decode 𝑁text tokens. The preliminary results
