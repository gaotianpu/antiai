...
YOLOv7-E6E(56.8% AP)实时模型在COCO数据集上的最大精度比目前最准确的美团/YOLOv6-s模型(43.1% AP)高+13.7% AP。 在 COCO 数据集和 V100 GPU with batch= 的相同条件下，我们的 YOLOv7-tiny (35.2% AP, 0.4 ms) 模型比 meituan/YOLOv6-n (35.0% AP, 0.5 ms) 快 +25% 和 +0.2% AP 32.
