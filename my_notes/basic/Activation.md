...
## From [yolo_v4](../../raw/cnn/yolo_v4.md):
...
* ReLU6 2017.4.17 [MobileNets: Efficient convolutional neural networks for mobile vision applications](../../raw/cnn/MobileNet_v1.md)
    * https://pytorch.org/docs/stable/generated/torch.nn.ReLU6.html
    * $min(max(0,x),6)$, 专为量化网络设计
    

* GELU, 2016.6.27 [GELU, Gaussian Error Linerar Units](../../raw/cnn/GELUs.md) 
...
* hard-Swish 2019.5.6 [Searching for MobileNetV3](../../raw/cnn/MobileNet_v3.md)
